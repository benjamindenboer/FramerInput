...
class exports.InputLayer extends TextLayer
	...
	constructor: (options={}) ->
		...
		for property, value of textProperties
			...
			@on "change:#{property}", (value) =>
				@_setTextProperties(@)
				@_setPlaceholder(@text or "Type something...")
	...
	_setTextProperties: (layer) =>
		...
		@_inputElement.style.fontSize = "#{layer.fontSize}px"
		...
		@_inputElement.style.width = "#{(layer.width * 2) - layer.padding.left * 2}px"
		@_inputElement.style.height = "#{layer.height * 2 / Utils.devicePixelRatio()}px"
		@_inputElement.style.cursor = "auto"
		@_inputElement.style.webkitAppearance = "none"
		@_inputElement.style.resize = "none"
		@_inputElement.style.paddingTop = "#{layer.padding.top * 2 / Utils.devicePixelRatio()}px"
		@_inputElement.style.paddingRight = "#{layer.padding.bottom * 2 / Utils.devicePixelRatio()}px"
		@_inputElement.style.paddingBottom = "#{layer.padding.right * 2 / Utils.devicePixelRatio()}px"
		@_inputElement.style.paddingLeft = "#{layer.padding.left * 2 / Utils.devicePixelRatio()}px"
